  ...
  return (
    <main className="flex-1 flex flex-col min-h-dvh" dir="rtl">
      ...
      <div className="flex items-center justify-between px-4 py-4">
        <button
          onClick={() => router.push('/')}
          className="w-10 h-10 flex items-center justify-center rounded-full bg-surface-tertiary text-text-muted hover:text-text-primary transition-colors"
        >
          ✕
        </button>
                  ...
                  <div className="flex items-center gap-2">
                    {song.spotifyId && (
                      <a
                        ...
                        className="w-8 h-8 rounded-full bg-[#1DB954]/15 flex items-center justify-center hover:bg-[#1DB954]/25 transition-colors"
                      >
                    ...
                    <button
                      ...
                      className="w-8 h-8 rounded-full bg-wrong/10 flex items-center justify-center hover:bg-wrong/20 transition-colors opacity-0 group-hover:opacity-100"
